package com.softsquared.naverwebtoon.src.main.fragmentwebtoon.fragmentsunday;
...
public class FragmentWebtoonFragmentSunday extends Fragment implements MainActivityView {
    private ArrayList<Result> items = new ArrayList<>();
    RecyclerView recyclerView = null;
    Context context= null;
    WebtoonRecyclerViewAdapter adapter = null;

    public FragmentWebtoonFragmentSunday(){}
    ...
    public void tryGetWebtoonList(){
        final SundayService sundayService = new SundayService(this);
        sundayService.getWebtoonList();
    }
