...
public class FragmentWebtoonFragmentFriday extends Fragment implements MainActivityView {
    private ArrayList<Result> items = new ArrayList<>();
    RecyclerView recyclerView = null;
    Context context= null;
    WebtoonRecyclerViewAdapter adapter = null;

    public FragmentWebtoonFragmentFriday(){}
    ...
    public void tryGetWebtoonList(){
        final FridayService fridayService = new FridayService(this);
        fridayService.getWebtoonList();
    }
