package com.softsquared.naverwebtoon.src.main.fragmentwebtoon.fragmentend;
...
public class FragmentWebtoonFragmentEnd extends Fragment implements MainActivityView {
    private ArrayList<Result> items = new ArrayList<>();
    RecyclerView recyclerView = null;
    Context context= null;
    WebtoonRecyclerViewAdapter adapter = null;

    public FragmentWebtoonFragmentEnd(){}
    ...
    public void tryGetWebtoonList(){
        final EndService endService = new EndService(this);
        endService.getWebtoonList();
    }
