...
public class FragmentAllCommentService {
    private final CommentActivityView mCommentActivityView;
    private final int idx;

    public FragmentAllCommentService(CommentActivityView mCommentActivityView, int idx) {
    ...
    public void getCommentList(){
        ...
        commentRetrofitInterface.getComment(idx,"전체").enqueue(new Callback<CommentResponse>() {
            @Override
