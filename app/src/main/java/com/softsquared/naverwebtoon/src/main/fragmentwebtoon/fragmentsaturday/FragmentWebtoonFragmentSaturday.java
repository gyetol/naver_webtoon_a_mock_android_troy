...
public class FragmentWebtoonFragmentSaturday extends Fragment implements MainActivityView {
    private ArrayList<Result> items = new ArrayList<>();
    RecyclerView recyclerView = null;
    Context context= null;
    WebtoonRecyclerViewAdapter adapter = null;

    public FragmentWebtoonFragmentSaturday(){}
    ...
    public void tryGetWebtoonList(){
        final SaturdayService saturdayService = new SaturdayService(this);
        saturdayService.getWebtoonList();
    }
