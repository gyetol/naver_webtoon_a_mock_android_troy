package com.softsquared.naverwebtoon.src.main.fragmentwebtoon.fragmentmonday;
...
public class FragmentWebtoonFragmentMonday extends Fragment implements MainActivityView {
    ...
    public void tryGetWebtoonList(){
        final MondayService mondayService = new MondayService(this);
        mondayService.getWebtoonList();
    }
