...
public class FragmentWebtoonFragmentThursday extends Fragment implements MainActivityView {
    ...
    public void tryGetWebtoonList(){
        final ThursdayService thursdayService = new ThursdayService(this);
        thursdayService.getWebtoonList();
    }
