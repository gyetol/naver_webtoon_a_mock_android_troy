package com.softsquared.naverwebtoon.src.main.fragmentwebtoon.fragmentwednesday;
...
public class FragmentWebtoonFragmentWednesday extends Fragment implements MainActivityView {
    private ArrayList<Result> items = new ArrayList<>();
    RecyclerView recyclerView = null;
    Context context= null;
    WebtoonRecyclerViewAdapter adapter = null;

    public FragmentWebtoonFragmentWednesday(){}
    ...
    public void tryGetWebtoonList(){
        final WednesdayService wednesdayService = new WednesdayService(this);
        wednesdayService.getWebtoonList();
    }
